...
{
    uint8_t res = 0;
    HAL_I2C_Mem_Read(&hi2c1, IST8310_IIC_ADDRESS <<1, reg,I2C_MEMADD_SIZE_8BIT,&res,1,10);
    return res;
}
...
{
    HAL_I2C_Mem_Write(&hi2c1, IST8310_IIC_ADDRESS <<1, reg,I2C_MEMADD_SIZE_8BIT,&data,1,10);
}
...
{
    HAL_I2C_Mem_Read(&hi2c1, IST8310_IIC_ADDRESS <<1, reg,I2C_MEMADD_SIZE_8BIT,buf,len,10);
}
...
{
    HAL_I2C_Mem_Write(&hi2c1, IST8310_IIC_ADDRESS <<1, reg,I2C_MEMADD_SIZE_8BIT,data,len,10);
}
